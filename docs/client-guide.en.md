...
- [Stage 6 | User System Commands](#stage-6--user-system-commands)
  - [register - Register User](#register---register-user)
  - [login - Login](#login---login)
  - [logout - Logout](#logout---logout)
  - [whoami - Show Current User](#whoami---show-current-user)
- [Stage 1 | Basic Commands](#stage-1--basic-commands)
  - [ping - Test Connection](#ping---test-connection)
- [Stage 2-3 | Link Management Commands](#stage-2-3--link-management-commands)
  - [add - Add Link](#add---add-link)
  - [list - List Links](#list---list-links)
  - [delete - Delete Link](#delete---delete-link)
- [Stage 4 | Monitoring Commands](#stage-4--monitoring-commands)
  - [watch - Monitor Link](#watch---monitor-link)
- [Stage 5 | Enhanced Features](#stage-5--enhanced-features)
  - [search - Search Links](#search---search-links)
