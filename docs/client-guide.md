...
- [安装与配置](#安装与配置)
- [全局参数](#全局参数)
- [Stage 6 | 用户系统命令](#stage-6--用户系统命令)
  - [register - 注册用户](#register---注册用户)
  - [login - 登录](#login---登录)
  - [logout - 登出](#logout---登出)
  - [whoami - 查看当前用户](#whoami---查看当前用户)
- [Stage 1 | 基础命令](#stage-1--基础命令)
  - [ping - 测试连接](#ping---测试连接)
- [Stage 2-3 | 链接管理命令](#stage-2-3--链接管理命令)
  - [add - 添加链接](#add---添加链接)
  - [list - 列出链接](#list---列出链接)
  - [delete - 删除链接](#delete---删除链接)
- [Stage 4 | 监控命令](#stage-4--监控命令)
  - [watch - 监控链接](#watch---监控链接)
- [Stage 5 | 增强功能](#stage-5--增强功能)
  - [search - 搜索链接](#search---搜索链接)
  - [open - 打开链接](#open---打开链接)
- [使用示例](#使用示例)
- [常见问题](#常见问题)
